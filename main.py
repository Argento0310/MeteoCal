...
class Window(QMainWindow):
    ...
    def initUI(self):
        ...
        self.setStyleSheet("background-color:#252740;color:white; font-family:sans-serif; font-size:15px")
        ...
        self.timerCheckBox = QCheckBox('Timer ON', self)
        ...
        self.tileCheckBox = QCheckBox('賛美', self)
